...
var checkjwt = require("../middlewares/jwtMiddleware");
var router = express.Router();
var jwt = require("express-jwt");
var secret = "bitchlasagnaisapewdslang";
router.get("/users/:id", jwt({ secret: secret, algorithms: ['HS256'] }), checkjwt, function (req, res) {
...
router.put("/users/:id", jwt({ secret: secret, algorithms: ['HS256'] }), checkjwt, function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
